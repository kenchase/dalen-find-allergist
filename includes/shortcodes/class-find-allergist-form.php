...
?>
        ...
        <div id="allergist-search" class="allergist-search">
            ...
            <form action="javascript:void(0);" id="allergist-search-form" class="allergist-search-form">
                <input type="hidden" name="Find" value="Physician" />

                <div class="form-field">
                    <label for="phy_name" class="form-field__label"><?php _e('Physician\'s Name', 'dalen-find-allergist'); ?></label>
                    <input type="text" id="phy_name" name="phy_name" placeholder="<?php _e('Search by Name', 'dalen-find-allergist'); ?>" value="" />
                </div>

                <div class="form-field">
                    <label for="phy_prac_pop" class="form-field__label"><?php _e('Practice Population', 'dalen-find-allergist'); ?></label>
                ...
                <div class="form-field">
                    <label for="phy_city" class="form-field__label"><?php _e('City', 'dalen-find-allergist'); ?></label>
                    <input type="text" id="phy_city" name="phy_city" value="" placeholder="<?php _e('Search by City', 'dalen-find-allergist'); ?>" />
                </div>

                <div class="form-field">
                    <label for="phy_province" class="form-field__label"><?php _e('Province', 'dalen-find-allergist'); ?></label>
                ...
                <div class="form-field">
                    <label for="phy_postal" class="form-field__label"><?php _e('Postal Code', 'dalen-find-allergist'); ?></label>
                ...
                <div class="form-field">
                    <label for="phy_kms" class="form-field__label"><?php _e('Within the Range of', 'dalen-find-allergist'); ?></label>
